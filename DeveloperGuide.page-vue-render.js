...
with(this){return _c('ol',[_c('li',[_v("User specifies the tutorial class to be added")]),_v(" "),_c('li',[_v("TAHelper adds the tutorial class")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("2a: The tutorial class is not specified.\n"),_c('ul',[_c('li',[_v("Returns an error. Use case ends.")]),_v(" "),_c('li',[_v("3a: The tutorial class does not exist.\n"),_c('ul',[_c('li',[_v("Returns an error, and shows the list of tutorial classes available for that module. Use case ends.")])])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Thu, 29 Feb 2024, 12:27:39 GMT+8]")])])])}
}];
